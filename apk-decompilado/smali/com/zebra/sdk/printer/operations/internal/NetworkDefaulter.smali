...
.method private resetPrinter()V
    ...
    invoke-virtual {p0}, Lcom/zebra/sdk/printer/operations/internal/NetworkDefaulter;->isPrintingChannelInLineMode()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/zebra/sdk/printer/operations/internal/NetworkDefaulter;->connection:Lcom/zebra/sdk/comm/Connection;

    const-string v1, "device.prompted_default_network"
    ...
    iget-object v1, p0, Lcom/zebra/sdk/printer/operations/internal/NetworkDefaulter;->connection:Lcom/zebra/sdk/comm/Connection;
...
.method public execute()Ljava/lang/Void;
    ...
    invoke-virtual {p0}, Lcom/zebra/sdk/printer/operations/internal/NetworkDefaulter;->selectStatusChannelIfOpen()V
