...
.method private calibrate()V
    ...
    invoke-virtual {p0}, Lcom/zebra/sdk/printer/operations/internal/PrinterCalibrator;->isPrintingChannelInLineMode()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/zebra/sdk/printer/operations/internal/PrinterCalibrator;->connection:Lcom/zebra/sdk/comm/Connection;
    ...
    iget-object v1, p0, Lcom/zebra/sdk/printer/operations/internal/PrinterCalibrator;->connection:Lcom/zebra/sdk/comm/Connection;
...
.method public execute()Ljava/lang/Void;
    ...
    invoke-virtual {p0}, Lcom/zebra/sdk/printer/operations/internal/PrinterCalibrator;->selectStatusChannelIfOpen()V
